...
<div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
  ...
  {/* Menü container */}
  <div className={`max-md:absolute max-md:top-0 max-md:left-0 z-50 flex flex-col md:flex-row items-center max-md:justify-center gap-8 min-md:px-8 py-3 max-md:h-screen min-md:rounded-full
    ...
    {/* Menü linkleri */}
    <Link className='text-white' onClick={() => { scrollTo(0, 0); setIsOpen(false); }} to='/'>AnaSayfa</Link>
    <Link className='text-white' onClick={() => { scrollTo(0, 0); setIsOpen(false); }} to='/Kitaplar'>Kitaplar</Link>
    <Link className='text-white' onClick={() => { scrollTo(0, 0); setIsOpen(false); }} to='/Kayıt'>Kayıt</Link>
    <Link className='text-white' onClick={() => { scrollTo(0, 0); setIsOpen(false); }} to='/Okunacaklar'>Okunacaklar</Link>
    <Link className='text-white' onClick={() => { scrollTo(0, 0); setIsOpen(false); }} to='/Favoriler'>Favoriler</Link>
  </div>
